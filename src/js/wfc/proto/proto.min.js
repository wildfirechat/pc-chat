...
class WfcImpl {
    ...
    getMessagesEx(conversationTypes, lines, fromIndex, before = true, count = 20, withUser = '', contentTypes = []) {
    ...
    getUserMessagesEx(userId, conversationTypes, lines, fromIndex, before = true, count = 20, withUser = '', contentTypes = []) {
    ...
    getConversationFileRecords(conversation, beforeUid, count, successCB, failCB) {
        proto.getConversationFiles(JSON.stringify(conversation), Long.fromValue(beforeUid).toString(), count, (frsStr) => {
